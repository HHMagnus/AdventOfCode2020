...
set<tuple<int, int, int>> start_cubes(vector<string> lines)
{
...
vector<tuple<int, int, int>> get_neighbours(tuple<int, int, int> cube)
{
...
bool check_neighbour(tuple<int, int, int> neighbour, set<tuple<int, int, int>> &active_cubes, map<tuple<int, int, int>, int> &candidates)
{
...
void simulate(set<tuple<int, int, int>> &active_cubes)
{
    map<tuple<int, int, int>, int> candidates;
    set<tuple<int, int, int>> deactivated;
...
void simulate(set<tuple<int, int, int>> &active_cubes, int turns)
{
...
int main()
{
    set<tuple<int, int, int>> active_cubes = start_cubes(get_lines());

    simulate(active_cubes, 6);

    cout << "Day 1: " << active_cubes.size() << '\n';
